...
class Model(Network):
	...
	def _make_train_function(self):
		print("***Within _make_train_function.  ")
		...
		if self.train_function is None:
			...
			if self._uses_dynamic_learning_phase():
				print("*** uses dynamic learning phase ***")
		...
		print("***end of  _make_train_function.  ")
	...
	def _make_predict_function(self):
		#print("***_make_predict_function has been called")
		if not hasattr(self, 'predict_function'):
			#print("*** class does not have attribute 'predict_function'")
			self.predict_function = None
		if self.predict_function is None:
			if self._uses_dynamic_learning_phase():
				#print("*** Use dynamic learning phase")
				inputs = self._feed_inputs + [K.learning_phase()]
			else:
				#print("*** Don't use dynamic learning phase")
				inputs = self._feed_inputs
			# Gets network outputs. Does not update weights.
			# Does update the network states.
			kwargs = getattr(self, '_function_kwargs', {})
			#print("Here is kwargs:")
			#print(kwargs)
	...
	def predict(self, x,
		...
		print("***Within the predict function***")
		batch_size = self._validate_or_infer_batch_size(batch_size, steps, x)
